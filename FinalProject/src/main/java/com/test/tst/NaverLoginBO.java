...
public class NaverLoginBO {
    ...
    private final static String CLIENT_ID = "_s0JZjO27ugm1oIktx5Q";       //네이버API Client ID
    private final static String CLIENT_SECRET = "f0mPObgvB5";                      
    private final static String REDIRECT_URI = "http://localhost:8080/main/callback.do";
